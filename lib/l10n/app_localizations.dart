...
// Enum z obsługiwanymi językami aplikacji
enum AppLocale { pl, en, it }

// Rozszerzenie umożliwiające konwersję AppLocale na Locale Fluttera
...
// InheritedWidget do zarządzania aktualnym językiem i jego zmianą w drzewie widgetów
...
// Klasa do pobierania tłumaczeń na podstawie aktualnego języka
class S {
  ...
  // --- Sekcja Hero ---
  String get heroPill => _t(
        'Beautiful ◦ Functional ◦ Tailored',
        'Beautiful ◦ Functional ◦ Tailored',
        'Beautiful ◦ Functional ◦ Tailored',
      );
...
• Un restauro generale per creare una casa familiare contemporanea e di alta qualità, nel rispetto del carattere storico dell’edificio.''',
  ...
  String get prj2Short => _t(
        'Projekt nowoczesnej łazienki',
        'Contemporary bathroom design',
        'Bagno contemporaneo – progetto',
      );
...
Ho presentato due varianti (sinistra e destra) per consentire al cliente di scegliere e co‑progettare la soluzione ideale. Punto su apertura, flessibilità e collaborazione attiva per un risultato davvero su misura.''',
  ...
  String get prj4Short => _t(
        'Kuchnia dla dużej rodziny',
        'A family‑sized kitchen',
        'Cucina per una famiglia numerosa',
      );
...
Su richiesta della cliente, il progetto prevede una colonna forno e lo spazio per un frigorifero a doppia porta per la massima praticità e comfort.''',
  ...
  String get prj5Title =>
      _t('Naturalna łazienka', 'Organic Bathroom', 'Bagno Organico');
  String get prj6Title =>
      _t('Minimalistyczna kuchnia', 'Minimalist Kitchen', 'Cucina Minimalista');
  String get prj7Title => _t('Elegancka Łazienka z Marmurem',
      'Marble Elegance Bathroom', 'Bagno Marble Elegance');
  String get prj8Title =>
      _t('Projekt Salonu', 'Living Room Design', 'Progetto Soggiorno');
  String get prj9Title => _t('Lazienka w Leśnej Zieleni',
      'Forest Green Bathroom', 'Bagno Verde Foresta');
  String get prj10Title =>
      _t('Black & White', 'Black & White', 'Black & White');
  String get prj11Title =>
